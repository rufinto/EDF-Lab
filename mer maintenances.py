# Simulateur pour le cas en mer avec maintenances et sans biocides
...
def test_tubes(a,b):
    ...
    for i in range(a,b+1,c):
        ...
        print("computing : test_tubes processing "+str((i-a)/(b-a)*100)+"%")  #il print le taux d'avancement du programme parce que c'est vraiment long
